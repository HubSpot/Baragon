...
Baragon depends on Zookeeper to receive requests from Singularity and to relay requests from the service to the agent.  Using an existing Zookeeper cluster is totally fine if you happen to have one.
