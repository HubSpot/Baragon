...
if node[:nginx]
  default['baragon']['agent_yaml']['loadBalancerConfig']['checkConfigCommand'] =
    "#{node[:nginx][:binary]} -t"
  default['baragon']['agent_yaml']['loadBalancerConfig']['reloadConfigCommand'] =
    "#{node[:nginx][:binary]} -s reload"
else
  default['baragon']['agent_yaml']['loadBalancerConfig']['checkConfigCommand'] = '/bin/true'
  default['baragon']['agent_yaml']['loadBalancerConfig']['reloadConfigCommand'] = '/bin/true'
end
