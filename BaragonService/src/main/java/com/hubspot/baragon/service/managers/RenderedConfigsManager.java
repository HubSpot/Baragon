...
public class RenderedConfigsManager {
  ...
  @Inject
  public RenderedConfigsManager(BaragonStateDatastore stateDatastore,
  ...
  public List<BaragonConfigFile> synchronouslySendRenderConfigsRequest(String serviceId) throws Exception {
    ...
    final HttpRequest.Builder builder = HttpRequest.newBuilder().setUrl(baseUrl + "/renderedConfigs/" + serviceId);
