...
public class TestAgentManager extends AgentManager {
  ...
  @Inject
  public TestAgentManager(BaragonLoadBalancerDatastore loadBalancerDatastore,
    ...
    super(loadBalancerDatastore, stateDatastore, agentResponseDatastore, configuration, objectMapper, asyncHttpClient, baragonAgentRequestUriFormat, baragonAgentBatchRequestUriFormat, baragonAgentMaxAttempts, baragonAuthKey, baragonAgentRequestTimeout);
  ...
  @Override
  void sendFilteredBatchRequests(final String baseUrl, final List<BaragonRequestBatchItem> batch) {
    recentBatches.put(baseUrl, batch);
  }

  public void completeRequestWithFailure(String baseUrl, String url, String requestId, AgentRequestType requestType) {
    agentResponseDatastore.addAgentResponse(requestId, requestType, baseUrl, url, Optional.absent(), Optional.absent(), Optional.of("Caught exception processing agent response"));
    agentResponseDatastore.setPendingRequestStatus(requestId, baseUrl, false);
  }

  public void completeRequest(String baseUrl, String url, String requestId, AgentRequestType requestType) {
    agentResponseDatastore.addAgentResponse(requestId, requestType, baseUrl, url, Optional.of(200), Optional.of(""), Optional.<String>absent());
    agentResponseDatastore.setPendingRequestStatus(requestId, baseUrl, false);
  }
