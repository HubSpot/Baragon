...
public class BaragonServiceTestModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    BaragonConfiguration baragonConfiguration = getBaragonConfigurationForTestingServer(ts);
    ...
    binder().install(
        Modules.override(serviceModule)
        .with(new Module() {
          @Override
  ...
  private static BaragonConfiguration getBaragonConfigurationForTestingServer(final TestingServer ts) {
