...
public class PreferSameRackWeightingBalancedTest {
  private static final Collection<String> AVAILABILITY_ZONES = Arrays.asList(
    "us-east-1a",
    "us-east-1a",
    "us-east-1b",
    "us-east-1c",
  ...
  private static final Collection<UpstreamInfo> UPSTREAMS = AVAILABILITY_ZONES
    .stream()
    .map(
      availabilityZone ->
        new UpstreamInfo(
  ...
  private BaragonAgentMetadata generateBaragonAgentMetadata(String availabilityZone) {
    final BaragonAgentMetadata agentMetadata = new BaragonAgentMetadata(
      BASE_URI,
      AGENT_ID,
      Optional.of(DOMAIN),
  ...
  public void testSimpleCase1A() {
    ...
    final PreferSameRackWeightingHelper helper = new PreferSameRackWeightingHelper(
      CONFIGURATION,
      agentMetadata
    );
    for (String availabilityZone : AVAILABILITY_ZONES) {
      final UpstreamInfo currentUpstream = new UpstreamInfo(
        "testhost:8080",
        Optional.absent(),
        Optional.of(availabilityZone)
      );
      CharSequence result = helper.preferSameRackWeighting(
        UPSTREAMS,
        currentUpstream,
        null
      );
  ...
  public void testSimpleCase1B() {
    ...
    Assertions.assertEquals(
      Arrays.asList("weight=2", "weight=2", "weight=16", "backup", "backup"),
      results
    );
  }
  ...
  public void testSimpleCase1C() {
    ...
    Assertions.assertEquals(
      Arrays.asList("weight=2", "weight=2", "backup", "weight=16", "backup"),
      results
    );
  }
  ...
  public void testSimpleCase1E() {
    ...
    Assertions.assertEquals(
      Arrays.asList("weight=2", "weight=2", "backup", "backup", "weight=16"),
      results
    );
  }
  ...
  private static final Collection<String> LARGER_AVAILABILITY_ZONES = Arrays.asList(
    "us-east-1a",
    "us-east-1a",
    "us-east-1b",
    "us-east-1b",
  ...
  private static final Collection<UpstreamInfo> MANY_UPSTREAMS = LARGER_AVAILABILITY_ZONES
    .stream()
    .map(
      availabilityZone ->
        new UpstreamInfo(
  ...
  private static final Collection<String> NULL_AVAILABILITY_ZONES = Arrays.asList(
    null,
    null,
    null,
    null
  );
  private static final Collection<UpstreamInfo> NULL_UPSTREAMS = NULL_AVAILABILITY_ZONES
    .stream()
    .map(
      availabilityZone ->
        new UpstreamInfo("testhost:8080", Optional.absent(), Optional.absent())
    )
    .collect(Collectors.toList());
  ...
  private static final Collection<String> NEW_AVAILABILITY_ZONES = Arrays.asList(
    "us-east-1b",
    "us-east-1b",
    "us-east-1e",
    "us-east-1e",
  ...
  private static final Collection<UpstreamInfo> NEW_UPSTREAMS = NEW_AVAILABILITY_ZONES
    .stream()
    .map(
      availabilityZone ->
        new UpstreamInfo(
  ...
  public void testBigDecimalToIntegerCase1B() {
    ...
    Assertions.assertEquals(
      Arrays.asList("weight=9", "weight=9", "", "", "", "", "", ""),
      results
    );
  }
  ...
  public void testBigDecimalToIntegerCase1E() {
    ...
    Assertions.assertEquals(
      Arrays.asList("backup", "backup", "", "", "", "backup", "backup", "backup"),
      results
    );
  }
