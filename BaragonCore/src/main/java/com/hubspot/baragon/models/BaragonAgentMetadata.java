...
public class BaragonAgentMetadata {
  public static final Pattern AGENT_METADATA_STRING_REGEX = Pattern.compile(
    "^http[s]?:\\/\\/([^:\\/]+:\\d{1,5})\\/.*$"
  );
  ...
  public BaragonAgentMetadata(
    ...
    this.gcloud = gcloud;
    this.extraAgentData =
      MoreObjects.firstNonNull(extraAgentData, Collections.<String, String>emptyMap());
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof BaragonAgentMetadata) {
      ...
      return (
        Objects.equals(this.batchEnabled, that.batchEnabled) &&
